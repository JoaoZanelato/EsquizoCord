...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await register.post("/cadastro", {
        nome,
        email,
        senha,
      ...
      // Após o sucesso, redireciona para o login depois de alguns segundos
      setTimeout(() => {
        navigate("/login");
      }, 3000);
    } catch (err) {
    ...
    <RegisterPageContainer>
      <RegisterBox>
        ...
        <RegisterForm onSubmit={handleSubmit}>
          ...
          <RegisterButton type="submit" disabled={!!success}>
            Cadastrar
          </RegisterButton>
        </RegisterForm>
