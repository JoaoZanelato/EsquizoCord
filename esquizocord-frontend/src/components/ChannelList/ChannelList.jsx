      ...
      <>
        ...
        <MemberList>
          {groupDetails.members?.map((member) => {
            ...
            const memberRole =
              member.cargos && member.cargos.length > 0
                ? member.cargos[0]
                : null;
              ...
              >
                ...
                {isAI && (
                  <i
                    ...
                    style={{ marginLeft: "auto", color: "#8e9297" }}
                  ></i>
                )}
                ...
                {memberRole && !isAI && (
                  <i
                    ...
                    style={{ color: memberRole.cor, marginLeft: "auto" }}
                  ></i>
                )}
  ...
  return (
    <ChannelListContainer $isOpen={isChannelListOpen}>
      <ChannelHeader>
        ...
        {isGroupView &&
          user.id_usuario === groupDetails?.details?.id_criador && (
            <i
