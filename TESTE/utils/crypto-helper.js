...
if (!process.env.ENCRYPTION_SECRET_KEY || process.env.ENCRYPTION_SECRET_KEY.length !== 64) {
    throw new Error('FATAL ERROR: A variável de ambiente ENCRYPTION_SECRET_KEY é necessária e deve ser uma string hexadecimal de 64 caracteres.');
}
...
function encrypt(text) {
    ...
    const ciphertextWithAuthTag = Buffer.concat([encrypted, authTag]).toString('hex');
